    ...
    function login() {
        ...
        if ($this->form_validation->run() == true) { //check to see if the user is logging in
            ...
            if ($this->ion_auth->login($this->input->post('email'), $this->input->post('password'), $remember)) { //if the login is successful
                ...
                die('the login was un-successful');
                redirect('pages/login_error', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
            }
...
//				'type' => 'password',
//			);
            die('the form_validation was un-successful');
            $this->load->view('pages/login_error', $this->data);
        }
    }
...
//			);
            $this->load->view('pages/register_error', $this->data);
        }
    }
